...
public class AddVehicleCategoryActivity extends AppCompatActivity {
    ...
    public EditText getCategoryID() {
        return categoryID;
    }

    public void setCategoryID(EditText categoryID) {
    ...
    public Button getColorDisplay() {
        return colorDisplay;
    }

    public void setColorDisplay(Button colorDisplay) {
    ...
    public void setAddVehicle(Button addVehicle) {
