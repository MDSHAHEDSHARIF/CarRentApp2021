...
public class AddVehicleActivity extends AppCompatActivity {
    ...
    public EditText getSeats() {
        return seats;
    }

    public void setSeats(EditText seats) {
        this.seats = seats;
    }
    ...
    public void setMileage(EditText mileage) {
        this.mileage = mileage;
    }

    public EditText getManufacturer() {
        return manufacturer;
    }

    public void setManufacturer(EditText manufacturer) {
    ...
    public void setModel(EditText model) {
        this.model = model;
    }
    ...
    public EditText getImageURL() {
        return imageURL;
    }

    public void setImageURL(EditText imageURL) {
        this.imageURL = imageURL;
    }

    public CheckBox getAvailability() {
        return availability;
    }

    public void setAvailability(CheckBox availability) {
    ...
    public Button getVehicleCategory() {
        return vehicleCategory;
    }

    public void setVehicleCategory(Button vehicleCategory) {
    ...
    public void setViewResult(Button viewResult) {
    ...
    public VehicleCategoryDao getVehicleCategoryDao() {
        return vehicleCategoryDao;
    }

    public void setVehicleCategoryDao(VehicleCategoryDao vehicleCategoryDao) {
