...
public class LoginActivity extends AppCompatActivity {
    ...
    public TextView getForgotPass() {
        return forgotPass;
    }

    public void setForgotPass(TextView forgotPass) {
    ...
    public Project_Database getDb() {
        return db;
    }

    public void setDb(Project_Database db) {
        this.db = db;
    }
    ...
    public Button getVehicle() {
        return vehicle;
    }

    public void setVehicle(Button vehicle) {
        this.vehicle = vehicle;
    }

    public Button getPopulate() {
        return populate;
    }

    public void setPopulate(Button populate) {
